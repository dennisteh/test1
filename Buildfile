...
# This is your Buildfile for your app, Test1. This tells SproutCore
...
# config :test1, :javascript_libs => ['https://maps.googleapis.com/maps/api/js?v=3&sensor=false']
# config :test1, :load_fixtures => true
config :test1, :required => :sproutcore
